...
export default function StudioOverview({ active = false }) {
  ...
  id="studio-video"
  ref={sectionRef}
  className={`relative h-screen w-full bg-black transition-opacity duration-300 ${
    isVideoVisible
      ? "opacity-100 pointer-events-auto cursor-close"
...
>
  ...
  <div className="absolute inset-0 flex items-center justify-center p-10">
    <div
      className="max-w-7xl aspect-video  overflow-hidden"
